...
import com.hafu.Hafu.view.BaseFragmentAdapter;
import com.hafu.Hafu.view.GuideViewPager;
import com.hafu.Hafu.view.LauncherBaseFragment;
import com.hafu.Hafu.view.PrivateMessageLauncherFragment;
import com.hafu.Hafu.view.RewardLauncherFragment;
import com.hafu.Hafu.view.StereoscopicLauncherFragment;
...
public class KaKaLauncherActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < tips.length; i++) {
            ...
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(new ViewGroup.LayoutParams(ViewPager.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
